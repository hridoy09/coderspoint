            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
					...
					<div class="form-group row">
	                    ...
	                    <div class="col-lg-6">
	                        <input type="file" name="logo" class="form-control" accept="*/image" onchange="readURL(this);">
						...
						<div class="form-group row">
		                    <label class="col-lg-4 col-form-label" for="val-category">E-mail<span class="text-danger">*</span>
		                    </label>
		                    <div class="col-lg-6">
		                        <input type="text" required class="form-control" name="email" value="{{ $site->email }}">
		                    </div>
		                </div>
						<div class="form-group row">
		                    <label class="col-lg-4 col-form-label" for="val-category">Address<span class="text-danger">*</span>
		                    </label>
		                    <div class="col-lg-6">
		                        <input type="text" required class="form-control" name="address" value="{{ $site->address }}">
		                    </div>
		                </div>
						<div class="form-group row">
		                    <label class="col-lg-4 col-form-label" for="val-category">City<span class="text-danger">*</span>
		                    </label>
		                    <div class="col-lg-6">
		                        <input type="text" required class="form-control" name="city" value="{{ $site->city }}">
		                    </div>
		                </div>
