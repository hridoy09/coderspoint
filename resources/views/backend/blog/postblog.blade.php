                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-validation">
                            ...
                            @endif
                            <form class="form-valide" action="{{route('admin.blog.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input style=";"   name='tags'   value='' autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="form-control" name="description" id="exampleFormControlTextarea4" ></textarea>
                                    </div>
                                </div>
