                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    ...
                                    <form class="form-valide" action="{{ url('admin/category/subcategory/update/'.$subcategory->id) }}" method="post">
                                    	@csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" required class="form-control" name="subcategory_name" value="{{ $subcategory->subcategory_name }}">
                                            </div>
                                        </div>
